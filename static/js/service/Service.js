export class Service {
    ...
    moveToCurrenLocation() {
        ...
        this.map.map.controls[google.maps.ControlPosition.TOP_CENTER].push(locationButton);
    ...
    showAllMarker() {
        ...
        this.map.map.controls[google.maps.ControlPosition.BOTTOM_LEFT].push(container);
